...
| [Modificadores de consultas Eloquent](query-modifiers.md) | `QueryFilter`, `QueryOptions` y `ApplyQueryModifiers`: filtros y opciones tipados para consultas Eloquent |
