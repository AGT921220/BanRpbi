...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This URL is used to prefix generated asset URLs (including Vite build
    | assets). Leave null to use the current request / APP_URL. In HTTPS
    | production you can set this to https://your-domain.com if needed.
    |
    */
